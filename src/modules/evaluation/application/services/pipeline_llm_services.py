...
class PipelineLLMServices:
    ...
    def classify_startup(self, full_text: str, images: Optional[List[str]] = None) -> ClassificationResult:
    ...
    def write_report(self, scoring_result_json: str) -> ReportWriterResult:
